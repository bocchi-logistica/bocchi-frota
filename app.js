        ...
        React.createElement("div", { className: "login-card" },
            ...
            React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 12 } },
                React.createElement("div", null,
                    ...
                    React.createElement("input", { value: login, onChange: e => setLogin(e.target.value), placeholder: "ex.: adelir", autoCapitalize: "none" })),
                React.createElement("div", null,
                    React.createElement("label", null, "Senha"),
                    React.createElement("div", { className: "row", style: { gap: 8 } },
                        React.createElement("input", { className: "grow", type: senhaLoginVisivel ? 'text' : 'password', value: senha, onChange: e => setSenha(e.target.value), onKeyDown: e => e.key === 'Enter' && entrar(), placeholder: "\u2022\u2022\u2022\u2022", autoComplete: "current-password" }),
    ...
    return (React.createElement(React.Fragment, null,
        ...
        contestar &&
            React.createElement(Modal, { titulo: "Contestar carga", onClose: () => setContestar(null) },
                ...
                React.createElement("label", null, "O que est\u00E1 errado?"),
                React.createElement("textarea", { rows: "4", value: motivo, onChange: e => setMotivo(e.target.value), placeholder: "Ex.: o peso est\u00E1 diferente do ticket da balan\u00E7a..." }),
        ...
        preenchendo && React.createElement(React.Fragment, null,
            modoOcorrenciaAgendamento && React.createElement("div", { className: "card", style: { borderLeft: '4px solid var(--colheita)' } },
                ...
                React.createElement("div", { style: { marginTop: 12 } },
                    React.createElement("label", null, "Grupo com problema"),
                    React.createElement("select", { value: grupoOcorrencia, onChange: e => { setGrupoOcorrencia(e.target.value); setResps({}); } },
            ...
            React.createElement("div", { className: "card" },
                ...
                React.createElement("div", { className: "form-grid", style: { marginTop: 12 } },
                    React.createElement("div", null,
                        React.createElement("label", null, "KM atual *"),
                        React.createElement("input", { type: "number", inputMode: "numeric", value: extras.km, onChange: e => setExtras({ ...extras, km: e.target.value }), placeholder: "Ex.: 158420" })),
                    frotaSel === 'leve' && !modoOcorrenciaAgendamento &&
                        React.createElement("div", null,
                            React.createElement("label", null, "N\u00EDvel de combust\u00EDvel"),
                            React.createElement("select", { value: extras.combustivel, onChange: e => setExtras({ ...extras, combustivel: e.target.value }) },
                                React.createElement("option", { value: "" }, "Selecionar..."),
        ...
        configOcorrencia && React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "card sinistro-bloco-compacto" },
                ...
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", null,
                        React.createElement("label", null, "Detalhe da ocorr\u00EAncia *"),
                        React.createElement("select", { value: form.tipoSinistro, onChange: e => setForm({ ...form, tipoSinistro: e.target.value }) }, (configOcorrencia.detalhes || ['Outro']).map(x => React.createElement("option", { key: x }, x)))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Placa *"),
                        React.createElement("select", { value: form.placa, onChange: e => setForm({ ...form, placa: e.target.value }) },
                            React.createElement("option", { value: "" }, "Selecionar..."),
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("input", { type: "datetime-local", value: form.dataHoraOcorrido, onChange: e => setForm({ ...form, dataHoraOcorrido: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Motorista *"),
                        React.createElement("input", { value: form.motoristaNome, onChange: e => setForm({ ...form, motoristaNome: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Telefone"),
                        React.createElement("input", { value: form.motoristaTelefone, onChange: e => setForm({ ...form, motoristaTelefone: e.target.value }), placeholder: "(54) 99999-9999" })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Munic\u00EDpio"),
                        React.createElement("input", { value: form.municipio, onChange: e => setForm({ ...form, municipio: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "UF"),
                        React.createElement("select", { value: form.uf, onChange: e => setForm({ ...form, uf: e.target.value }) }, ['RS', 'SC', 'PR', 'SP', 'MG', 'RJ', 'ES', 'MS', 'MT', 'GO', 'DF', 'BA', 'SE', 'AL', 'PE', 'PB', 'RN', 'CE', 'PI', 'MA', 'TO', 'PA', 'AP', 'AM', 'RR', 'RO', 'AC'].map(x => React.createElement("option", { key: x }, x)))),
                    React.createElement("div", { style: { gridColumn: '1/-1' } },
                        React.createElement("label", null, "Local *"),
                        React.createElement("input", { value: form.localOcorrido, onChange: e => setForm({ ...form, localOcorrido: e.target.value }), placeholder: "Rodovia, km, endere\u00E7o ou refer\u00EAncia" }))),
                React.createElement("div", { className: "form-grid", style: { marginTop: 10 } },
                    React.createElement("div", null,
                        React.createElement("label", null, "Ve\u00EDculo imobilizado?"),
                        React.createElement("select", { value: form.veiculoImobilizado ? 'sim' : 'nao', onChange: e => setForm({ ...form, veiculoImobilizado: e.target.value === 'sim' }) },
                            React.createElement("option", { value: "nao" }, "N\u00E3o"),
                            React.createElement("option", { value: "sim" }, "Sim"))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Precisa de guincho?"),
                        React.createElement("select", { value: form.necessitaGuincho ? 'sim' : 'nao', onChange: e => setForm({ ...form, necessitaGuincho: e.target.value === 'sim' }) },
                            React.createElement("option", { value: "nao" }, "N\u00E3o"),
                            React.createElement("option", { value: "sim" }, "Sim"))),
                    form.tipoOcorrencia === 'Acidente' && React.createElement(React.Fragment, null,
                        React.createElement("div", null,
                            React.createElement("label", null, "Possui v\u00EDtima?"),
                            React.createElement("select", { value: form.possuiVitima ? 'sim' : 'nao', onChange: e => setForm({ ...form, possuiVitima: e.target.value === 'sim' }) },
                                React.createElement("option", { value: "nao" }, "N\u00E3o"),
                                React.createElement("option", { value: "sim" }, "Sim"))),
                        React.createElement("div", null,
                            React.createElement("label", null, "Possui terceiro?"),
                            React.createElement("select", { value: form.possuiTerceiro ? 'sim' : 'nao', onChange: e => setForm({ ...form, possuiTerceiro: e.target.value === 'sim' }) },
                                React.createElement("option", { value: "nao" }, "N\u00E3o"),
                                React.createElement("option", { value: "sim" }, "Sim"))),
                        React.createElement("div", null,
                            React.createElement("label", null, "Responsabilidade inicial"),
                            React.createElement("select", { value: form.responsabilidadeInicial, onChange: e => setForm({ ...form, responsabilidadeInicial: e.target.value }) }, ['Ainda não definida', 'Possivelmente veículo Bocchi', 'Possivelmente terceiro', 'Responsabilidade compartilhada', 'Não se aplica'].map(x => React.createElement("option", { key: x }, x))))),
                    (form.tipoOcorrencia === 'Acidente' || form.tipoOcorrencia === 'Furto / Roubo / Vandalismo') && React.createElement(React.Fragment, null,
                        React.createElement("div", null,
                            React.createElement("label", null, "Autoridade acionada?"),
                            React.createElement("select", { value: form.autoridadeAcionada ? 'sim' : 'nao', onChange: e => { const sim = e.target.value === 'sim'; setForm({ ...form, autoridadeAcionada: sim, numeroBoletim: sim ? form.numeroBoletim : '' }); } },
                                React.createElement("option", { value: "nao" }, "N\u00E3o"),
                                React.createElement("option", { value: "sim" }, "Sim"))),
                        form.autoridadeAcionada && React.createElement("div", { style: { gridColumn: '1/-1' } },
                            React.createElement("label", null, "N\u00FAmero do B.O., se dispon\u00EDvel"),
                            React.createElement("input", { value: form.numeroBoletim, onChange: e => setForm({ ...form, numeroBoletim: e.target.value }), placeholder: "Informe o n\u00FAmero fornecido pela autoridade" }),
...
function FormAgendamento({ base, item, onClose, onSalvo, toast, admin = false, dataInicial = null }) {
    ...
    return React.createElement(Modal, { titulo: item ? 'Alterar agendamento' : 'Novo agendamento', onClose: onClose, large: true },
        React.createElement("div", { className: "agenda-modal-grid" },
            React.createElement("div", null,
                React.createElement("label", null, "Sa\u00EDda prevista"),
                React.createElement("input", { type: "datetime-local", min: minimoSaida, value: form.saidaPrevista, onChange: e => setForm({ ...form, saidaPrevista: e.target.value }) }),
                React.createElement("div", { className: "muted", style: { marginTop: 4 } }, "N\u00E3o \u00E9 permitido selecionar data/hor\u00E1rio anterior ao atual.")),
            React.createElement("div", null,
                React.createElement("label", null, "Retorno previsto"),
                React.createElement("input", { type: "datetime-local", min: form.saidaPrevista || minimoSaida, value: form.retornoPrevisto, onChange: e => setForm({ ...form, retornoPrevisto: e.target.value }) })),
            React.createElement("div", null,
                React.createElement("label", null, "Ve\u00EDculo compartilhado"),
                React.createElement("select", { value: form.veiculoId, onChange: e => setForm({ ...form, veiculoId: e.target.value }) },
                    React.createElement("option", { value: "" }, "Selecionar..."),
            ...
            React.createElement("div", null,
                React.createElement("label", null, "Motorista"),
                React.createElement("input", { value: form.motorista, onChange: e => setForm({ ...form, motorista: e.target.value }) })),
            React.createElement("div", null,
                React.createElement("label", null, "Origem"),
                React.createElement("input", { value: form.origem, onChange: e => setForm({ ...form, origem: e.target.value }) })),
            React.createElement("div", null,
                React.createElement("label", null, "Destino"),
                React.createElement("input", { value: form.destino, onChange: e => setForm({ ...form, destino: e.target.value }) })),
            React.createElement("div", null,
                React.createElement("label", null, "Possui passageiros?"),
                React.createElement("select", { value: form.possuiPassageiros ? 'sim' : 'nao', onChange: e => setForm({ ...form, possuiPassageiros: e.target.value === 'sim', quantidadePassageiros: e.target.value === 'sim' ? form.quantidadePassageiros : 0 }) },
                    React.createElement("option", { value: "nao" }, "N\u00E3o"),
                    React.createElement("option", { value: "sim" }, "Sim"))),
            form.possuiPassageiros && React.createElement("div", null,
                React.createElement("label", null, "Quantidade"),
                React.createElement("input", { type: "number", min: "1", value: form.quantidadePassageiros, onChange: e => setForm({ ...form, quantidadePassageiros: Number(e.target.value) }) })),
            React.createElement("div", { style: { gridColumn: '1/-1' } },
                React.createElement("label", null, "Observa\u00E7\u00E3o"),
                React.createElement("textarea", { rows: "3", value: form.observacao, onChange: e => setForm({ ...form, observacao: e.target.value }) }))),
    ...
    return React.createElement(Modal, { titulo: `${item.origem} → ${item.destino}`, onClose: onClose },
        ...
        acao && React.createElement("div", { style: { marginTop: 14 } },
            acao === 'cancelar' ? React.createElement(React.Fragment, null,
                React.createElement("label", null, "Motivo obrigat\u00F3rio"),
                React.createElement("select", { value: motivo, onChange: e => setMotivo(e.target.value) },
                    React.createElement("option", { value: "" }, "Selecionar..."),
                ...
                React.createElement("label", { style: { marginTop: 8 } }, "Observa\u00E7\u00E3o"),
                React.createElement("textarea", { value: obs, onChange: e => setObs(e.target.value) })) : React.createElement(React.Fragment, null,
                ...
                acao === 'corrigir' && React.createElement(React.Fragment, null,
                    React.createElement("label", { style: { marginTop: 8 } }, "KM final correto"),
                    React.createElement("input", { type: "number", value: obs, onChange: e => setObs(e.target.value) }),
                    React.createElement("label", { style: { marginTop: 8 } }, "Motivo"),
                    React.createElement("textarea", { value: motivo, onChange: e => setMotivo(e.target.value) })),
        ...
        carregando ? React.createElement("div", { className: "card muted" }, "Carregando agenda...") : React.createElement(React.Fragment, null,
            React.createElement("div", { className: "agenda-top" },
                React.createElement("div", { className: "agenda-filtros" },
                    React.createElement("div", null,
                        React.createElement("label", null, "Ve\u00EDculo"),
                        React.createElement("select", { value: veiculoFiltro, onChange: e => setVeiculoFiltro(e.target.value) },
                            ...
                            base.veiculos.map(v => React.createElement("option", { key: v.id, value: v.placa },
                                ...
                                v.modelo || v.tipoModelo || 'Sem modelo')))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Visualizar"),
                        React.createElement("select", { value: visual, onChange: e => setVisual(e.target.value) },
    ...
    return React.createElement(React.Fragment, null,
        ...
        carregando ? React.createElement("div", { className: "card muted" }, "Carregando agendamentos...") : sub === 'agenda' ? React.createElement(ConteudoAgendaGeral, null) : sub === 'monitor' ? React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "card" },
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", null,
                        React.createElement("label", null, "Per\u00EDodo de"),
                        React.createElement("input", { type: "date", value: fDataIniRel, onChange: e => setFDataIniRel(e.target.value) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "At\u00E9"),
                        React.createElement("input", { type: "date", value: fDataFimRel, onChange: e => setFDataFimRel(e.target.value) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Ve\u00EDculo"),
                        React.createElement("select", { value: fPlacaRel, onChange: e => setFPlacaRel(e.target.value) },
                            React.createElement("option", { value: "TODAS" }, "Todas as placas"),
                            placasRel.map(p => React.createElement("option", { key: p, value: p }, p)))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Status"),
                        React.createElement("select", { value: fStatus, onChange: e => setFStatus(e.target.value) },
                            React.createElement("option", { value: "TODOS" }, "Todos os status"),
            ...
            React.createElement("div", { className: "card" },
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", null,
                        React.createElement("label", null, "Dias permitidos para frente"),
                        React.createElement("input", { type: "number", value: paramForm.diasPermitidosFrente ?? '', onChange: e => alterarParam('diasPermitidosFrente', Number(e.target.value)) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Anteced\u00EAncia m\u00EDnima para criar/agendar (horas)"),
                        React.createElement("input", { type: "number", value: paramForm.antecedenciaMinimaHoras ?? '', onChange: e => alterarParam('antecedenciaMinimaHoras', Number(e.target.value)) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Dura\u00E7\u00E3o m\u00E1xima (horas)"),
                        React.createElement("input", { type: "number", value: paramForm.duracaoMaximaHoras ?? '', onChange: e => alterarParam('duracaoMaximaHoras', Number(e.target.value)) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Intervalo entre reservas (minutos)"),
                        React.createElement("input", { type: "number", value: paramForm.intervaloReservasMinutos ?? '', onChange: e => alterarParam('intervaloReservasMinutos', Number(e.target.value)) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Hora inicial permitida"),
                        React.createElement("input", { type: "time", value: paramForm.horaInicialPermitida || '00:00', onChange: e => alterarParam('horaInicialPermitida', e.target.value) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Hora final permitida"),
                        React.createElement("input", { type: "time", value: paramForm.horaFinalPermitida || '23:59', onChange: e => alterarParam('horaFinalPermitida', e.target.value) })),
                    React.createElement("div", null,
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Periodicidade do checklist"),
                        React.createElement("select", { value: paramForm.checklistPeriodicidade || 'SEMANAL', onChange: e => alterarParam('checklistPeriodicidade', e.target.value) },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "C\u00F3digo checklist Frota Leve"),
                        React.createElement("input", { value: paramForm.codigoChecklistFrotaLeve || '', onChange: e => alterarParam('codigoChecklistFrotaLeve', e.target.value) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Libera retirada antes da sa\u00EDda (minutos)"),
                        React.createElement("input", { type: "number", value: paramForm.janelaRetiradaMinutos ?? '', onChange: e => alterarParam('janelaRetiradaMinutos', Number(e.target.value)) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Toler\u00E2ncia devolu\u00E7\u00E3o (minutos)"),
                        React.createElement("input", { type: "number", value: paramForm.toleranciaDevolucaoMinutos ?? '', onChange: e => alterarParam('toleranciaDevolucaoMinutos', Number(e.target.value)) })),
                    React.createElement("div", null,
    ...
    return React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: "card" },
            React.createElement("div", { className: "filtros-cadastro", style: { margin: 0 } },
                React.createElement("div", null,
                    React.createElement("label", null, "Motorista"),
                    React.createElement("input", { value: nome, onChange: e => setNome(e.target.value), placeholder: "Filtrar por nome" })),
                React.createElement("div", null,
                    React.createElement("label", null, "Ano"),
                    React.createElement("select", { value: ano, onChange: e => setAno(e.target.value) }, [2025, 2026, 2027, 2028].map(a => React.createElement("option", { key: a }, a)))),
                React.createElement("div", null,
                    React.createElement("label", null, "Pagamento"),
                    React.createElement("select", { value: quadrimestre, onChange: e => setQuadrimestre(e.target.value) },
                ...
                React.createElement("div", null,
                    React.createElement("label", null, "Escopo da atualiza\u00E7\u00E3o"),
                    React.createElement("select", { value: modoAtualizacao, disabled: filaRH.rodando, onChange: e => setModoAtualizacao(e.target.value) },
...
function AdmPainel({ st, dados, user, onNavegar }) {
    ...
    const FiltrosCargas = () => React.createElement("div", { className: "card", style: { marginTop: 12 } },
        React.createElement("div", { className: "form-grid", style: { alignItems: 'end' } },
            React.createElement("div", null,
                React.createElement("label", null, "Compet\u00EAncia"),
                React.createElement("select", { value: mes, onChange: e => setMes(e.target.value) }, MESES_2026.map(m => React.createElement("option", { key: m, value: m }, mesLabel(m))))),
            React.createElement("div", null,
                React.createElement("label", null, "Motorista"),
                React.createElement("select", { value: fMotorista, onChange: e => setFMotorista(e.target.value) },
                    React.createElement("option", { value: "" }, "Todos"),
                    linhas.map(l => React.createElement("option", { key: l.uid, value: l.uid }, l.u.nome)))),
            React.createElement("div", null,
                React.createElement("label", null, "Tipo de ve\u00EDculo"),
            ...
            React.createElement("div", null,
                React.createElement("label", null, "Situa\u00E7\u00E3o"),
                React.createElement("select", { value: fSituacao, onChange: e => setFSituacao(e.target.value) },
    ...
    if (subPainel === 'detalhes' && motoristaDetalhe) {
        return React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "card", style: { marginTop: 12 } },
                React.createElement("div", { className: "form-grid", style: { alignItems: 'end' } },
                    React.createElement("div", null,
                        React.createElement("label", null, "Buscar NF, rota, placa ou produto"),
                        React.createElement("input", { value: fBuscaDetalhe, onChange: e => setFBuscaDetalhe(e.target.value), placeholder: "Digite para localizar" })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Produto"),
                        React.createElement("select", { value: fProdutoDetalhe, onChange: e => setFProdutoDetalhe(e.target.value) },
                            React.createElement("option", { value: "" }, "Todos"),
                            produtosDetalhe.map(p => React.createElement("option", { key: p, value: p }, p)))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Data inicial"),
                        React.createElement("input", { type: "date", value: fDataInicialDetalhe, onChange: e => setFDataInicialDetalhe(e.target.value) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Data final"),
                        React.createElement("input", { type: "date", value: fDataFinalDetalhe, onChange: e => setFDataFinalDetalhe(e.target.value) })))),
    ...
    return (React.createElement(React.Fragment, null,
        ...
        respondendo &&
            React.createElement(Modal, { titulo: "Responder contesta\u00E7\u00E3o", onClose: () => setRespondendo(null) },
                ...
                React.createElement("label", null, "Resposta ao motorista"),
                React.createElement("textarea", { rows: "3", value: resposta, onChange: e => setResposta(e.target.value), placeholder: decisao === 'procede' ? 'Ex.: confirmado com o ticket, peso será corrigido na próxima importação.' : 'Ex.: conferimos com a balança e o valor está correto.' }),
    ...
    return (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "card" },
                ...
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", { style: { gridColumn: '1/-1' } },
                        ...
                        React.createElement("input", { value: novaPerg.texto, onChange: e => setNovaPerg({ ...novaPerg, texto: e.target.value }), placeholder: "Ex.: Cintas e catracas de amarra\u00E7\u00E3o em condi\u00E7\u00F5es" })),
                    React.createElement("div", null,
                        React.createElement("label", null, "TipoVe\u00EDculo"),
                        React.createElement("select", { value: novaPerg.frota, onChange: e => setNovaPerg({ ...novaPerg, frota: e.target.value }) },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("select", { value: novaPerg.grupo, onChange: e => setNovaPerg({ ...novaPerg, grupo: e.target.value }) },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Frequ\u00EAncia"),
                        React.createElement("select", { value: novaPerg.frequencia, onChange: e => setNovaPerg({ ...novaPerg, frequencia: e.target.value }) },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Ordem dentro do grupo"),
                        React.createElement("input", { type: "number", min: "0", step: "1", value: novaPerg.ordem, onChange: e => setNovaPerg({ ...novaPerg, ordem: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Resposta obrigat\u00F3ria?"),
                        React.createElement("select", { value: novaPerg.obrigatoria ? 's' : 'n', onChange: e => setNovaPerg({ ...novaPerg, obrigatoria: e.target.value === 's' }) },
                            React.createElement("option", { value: "s" }, "Sim"),
                            React.createElement("option", { value: "n" }, "N\u00E3o"))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Foto obrigat\u00F3ria se NC?"),
                        React.createElement("select", { value: novaPerg.fotoNC ? 's' : 'n', onChange: e => setNovaPerg({ ...novaPerg, fotoNC: e.target.value === 's' }) },
                            React.createElement("option", { value: "n" }, "N\u00E3o"),
                            React.createElement("option", { value: "s" }, "Sim")))),
                React.createElement("div", { className: "row", style: { marginTop: 12 } },
            ...
            React.createElement(ChecklistDetalhe, { ck: ver, perguntas: st.perguntas, onClose: () => setVer(null), acoes: ver.status === 'pendente' &&
                    React.createElement("div", null,
                        React.createElement("div", { className: "card", style: { boxShadow: 'none', border: '1px solid var(--linha)', marginBottom: 10 } },
                            React.createElement("label", null, "Bloquear o ve\u00EDculo ap\u00F3s aprovar?"),
                            React.createElement("select", { value: bloquearAoAprovar ? 's' : 'n', onChange: e => setBloquearAoAprovar(e.target.value === 's') },
                                React.createElement("option", { value: "n" }, "N\u00E3o"),
                                React.createElement("option", { value: "s" }, "Sim")),
                            bloquearAoAprovar && React.createElement("div", { style: { marginTop: 10 } },
                                React.createElement("label", null, "Motivo do bloqueio"),
                                React.createElement("textarea", { rows: "2", value: motivoBloqueio, onChange: e => setMotivoBloqueio(e.target.value), placeholder: "Ex.: pneu com avaria impeditiva; aguardar manuten\u00E7\u00E3o." }))),
                        React.createElement("div", { className: "row" },
        ...
        reprovando &&
            React.createElement(Modal, { titulo: "Reprovar check list", onClose: () => setReprovando(null) },
                React.createElement("label", null, "Motivo (o motorista ver\u00E1 e dever\u00E1 refazer)"),
                React.createElement("textarea", { rows: "3", value: motivoRep, onChange: e => setMotivoRep(e.target.value), placeholder: "Ex.: foto do vazamento n\u00E3o permite identificar o local; refazer com foto mais pr\u00F3xima." }),
        ...
        liberandoVeiculo && React.createElement(Modal, { titulo: 'Liberar veículo ' + liberandoVeiculo.placa, onClose: () => setLiberandoVeiculo(null) },
            ...
            React.createElement("label", null, "Observa\u00E7\u00E3o da libera\u00E7\u00E3o"),
            React.createElement("textarea", { rows: "3", value: observacaoLiberacao, onChange: e => setObservacaoLiberacao(e.target.value), placeholder: "Ex.: manuten\u00E7\u00E3o conclu\u00EDda e ve\u00EDculo conferido." }),
    ...
    return (React.createElement(React.Fragment, null,
        ...
        sub === 'painel' && pode(user, 'premiacao.visualizar') && React.createElement(React.Fragment, null,
            React.createElement("div", { className: "form-grid", style: { marginBottom: 12 } },
                React.createElement("div", null,
                    React.createElement("label", null, "Compet\u00EAncia"),
                    React.createElement("input", { type: "month", value: competencia, onChange: e => setCompetencia(e.target.value) }))),
        ...
        sub === 'desc' && pode(user, 'descontos.visualizar') && React.createElement(React.Fragment, null,
            React.createElement("div", { className: "card", style: { padding: 12 } },
                React.createElement("div", { className: "filtros-operacionais" },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("input", { value: fBuscaDesc, onChange: e => setFBuscaDesc(e.target.value), placeholder: "Motorista, categoria ou motivo" })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Status da confer\u00EAncia"),
                        React.createElement("select", { value: fStatusDesc, onChange: e => { setFStatusDesc(e.target.value); if (e.target.value === 'PENDENTES')
                                setFSituacaoDesc(''); } },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("select", { value: fCategoriaDesc, onChange: e => setFCategoriaDesc(e.target.value) },
                            React.createElement("option", { value: "" }, "Todas as categorias"),
                            categorias.map(c => React.createElement("option", { key: c }, c)))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Situa\u00E7\u00E3o lan\u00E7ada"),
                        React.createElement("select", { disabled: fStatusDesc === 'PENDENTES', value: fSituacaoDesc, onChange: e => setFSituacaoDesc(e.target.value) },
                            React.createElement("option", { value: "" }, "Todas"),
            ...
            podeEditarDescontos && React.createElement("div", { className: "card", id: "form-descontos" },
                ...
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", null,
                        React.createElement("label", null, "Motorista"),
                        React.createElement("select", { value: novoDesc.motoristaId, onChange: e => { const u = (painel.elegiveis || []).find(x => String(x.motoristaId) === String(e.target.value)); setNovoDesc({ ...novoDesc, motoristaId: e.target.value, motoristaNome: u?.nome || '' }); } },
                            React.createElement("option", { value: "" }, "Selecionar..."),
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Categoria"),
                        React.createElement("select", { value: novoDesc.categoria, onChange: e => setNovoDesc({ ...novoDesc, categoria: e.target.value }) }, categorias.map(c => React.createElement("option", { key: c }, c)))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Situa\u00E7\u00E3o"),
                        React.createElement("select", { value: novoDesc.situacao, onChange: e => setNovoDesc({ ...novoDesc, situacao: e.target.value, motoristaId: e.target.value === 'Com ocorrência' && novoDesc.motoristaId === '__TODOS__' ? '' : novoDesc.motoristaId }) },
                            React.createElement("option", null, "Sem ocorr\u00EAncia"),
                            React.createElement("option", null, "Com ocorr\u00EAncia"))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Quantidade"),
                        React.createElement("input", { type: "number", min: "0", value: novoDesc.quantidade, onChange: e => setNovoDesc({ ...novoDesc, quantidade: e.target.value }) })),
                    novoDesc.situacao === 'Com ocorrência' && React.createElement(React.Fragment, null,
                        React.createElement("div", null,
                            React.createElement("label", null, "Valor do desconto (R$)"),
                            React.createElement("input", { type: "number", min: "0", value: novoDesc.valor, onChange: e => setNovoDesc({ ...novoDesc, valor: e.target.value }) })),
                        React.createElement("div", null,
                            React.createElement("label", null, "Percentual (%)"),
                            React.createElement("input", { type: "number", min: "0", max: "100", value: novoDesc.percentual, onChange: e => setNovoDesc({ ...novoDesc, percentual: e.target.value }) })),
                        React.createElement("div", null,
                            React.createElement("label", null, "Data da ocorr\u00EAncia"),
                            React.createElement("input", { type: "date", value: novoDesc.dataOcorrencia, onChange: e => setNovoDesc({ ...novoDesc, dataOcorrencia: e.target.value }) })),
                        React.createElement("div", { style: { gridColumn: '1/-1' } },
                            React.createElement("label", null, "Motivo"),
                            React.createElement("textarea", { value: novoDesc.motivo, onChange: e => setNovoDesc({ ...novoDesc, motivo: e.target.value }) })))),
        ...
        edit &&
            React.createElement(Modal, { titulo: edit.itemId ? 'Editar meta' : 'Incluir meta', onClose: () => setEdit(null) },
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", { style: { gridColumn: '1/-1' } },
                        React.createElement("label", null, "Tipo de ve\u00EDculo"),
                        React.createElement("select", { value: edit.tipo, onChange: e => setEdit({ ...edit, tipo: e.target.value }) },
                            React.createElement("option", { value: "" }, "Selecionar..."),
                        ...
                        !tiposMeta.length &&
                            React.createElement("div", { className: "aviso-box", style: { marginTop: 8 } },
                                ...
                                ".")),
                    React.createElement("div", null,
                        React.createElement("label", null, "Start (R$)"),
                        React.createElement("input", { type: "number", value: edit.start, onChange: e => setEdit({ ...edit, start: Number(e.target.value) }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Meta (R$)"),
                        React.createElement("input", { type: "number", value: edit.meta, onChange: e => setEdit({ ...edit, meta: Number(e.target.value) }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Valor na meta (R$)"),
                        React.createElement("input", { type: "number", value: edit.valorMeta, onChange: e => setEdit({ ...edit, valorMeta: Number(e.target.value) }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Teto mensal (R$)"),
                        React.createElement("input", { type: "number", value: edit.teto, onChange: e => setEdit({ ...edit, teto: Number(e.target.value) }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "% start\u2192meta"),
                        React.createElement("input", { type: "number", value: edit.pctStart, onChange: e => setEdit({ ...edit, pctStart: Number(e.target.value) }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "% acima da meta"),
                        React.createElement("input", { type: "number", value: edit.pctMeta, onChange: e => setEdit({ ...edit, pctMeta: Number(e.target.value) }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Vig\u00EAncia in\u00EDcio"),
                        React.createElement("input", { type: "date", value: edit.vigIni, onChange: e => setEdit({ ...edit, vigIni: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Vig\u00EAncia fim"),
                        React.createElement("input", { type: "date", value: edit.vigFim, onChange: e => setEdit({ ...edit, vigFim: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Ativa"),
                        React.createElement("select", { value: edit.ativo === false ? 'nao' : 'sim', onChange: e => setEdit({ ...edit, ativo: e.target.value === 'sim' }) },
                            React.createElement("option", { value: "sim" }, "Sim"),
                            React.createElement("option", { value: "nao" }, "N\u00E3o")))),
    ...
    return (React.createElement(React.Fragment, null,
        ...
        sub === 'usuarios' && podeSub('cadastro.usuarios') && !carregandoCad && !erroCad && React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "filtros-cadastro" },
                React.createElement("div", null,
                    React.createElement("label", null, "Filtrar por nome"),
                    React.createElement("input", { value: fUsuario.nome, onChange: e => setFUsuario({ ...fUsuario, nome: e.target.value }), placeholder: "Digite o nome" })),
                React.createElement("div", null,
                    React.createElement("label", null, "Perfil"),
                    React.createElement("select", { value: fUsuario.perfil, onChange: e => setFUsuario({ ...fUsuario, perfil: e.target.value }) },
                ...
                React.createElement("div", null,
                    React.createElement("label", null, "Ordenar"),
                    React.createElement("select", { value: fUsuario.ordem, onChange: e => setFUsuario({ ...fUsuario, ordem: e.target.value }) },
        ...
        sub === 'frota' && podeSub('cadastro.veiculos') && !carregandoCad && !erroCad && React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "filtros-cadastro" },
                React.createElement("div", null,
                    React.createElement("label", null, "Placa"),
                    React.createElement("input", { value: fVeiculo.placa, onChange: e => setFVeiculo({ ...fVeiculo, placa: e.target.value }), placeholder: "Filtrar placa" })),
                React.createElement("div", null,
                    React.createElement("label", null, "Frota"),
                    React.createElement("select", { value: fVeiculo.frota, onChange: e => setFVeiculo({ ...fVeiculo, frota: e.target.value }) },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement("select", { value: fVeiculo.tipo, onChange: e => setFVeiculo({ ...fVeiculo, tipo: e.target.value }) },
                ...
                React.createElement("div", null,
                    React.createElement("label", null, "Ordenar"),
                    React.createElement("select", { value: fVeiculo.ordem, onChange: e => setFVeiculo({ ...fVeiculo, ordem: e.target.value }) },
        ...
        sub === 'vinculos' && podeSub('cadastro.vinculos') && !carregandoCad && !erroCad && React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "filtros-cadastro" },
                React.createElement("div", null,
                    React.createElement("label", null, "Placa"),
                    React.createElement("input", { value: fVinculo.placa, onChange: e => setFVinculo({ ...fVinculo, placa: e.target.value }), placeholder: "Filtrar placa" })),
                React.createElement("div", null,
                    React.createElement("label", null, "Usu\u00E1rio"),
                    React.createElement("input", { value: fVinculo.usuario, onChange: e => setFVinculo({ ...fVinculo, usuario: e.target.value }), placeholder: "Filtrar usu\u00E1rio" })),
                React.createElement("div", null,
                    React.createElement("label", null, "Status"),
                    React.createElement("select", { value: fVinculo.status, onChange: e => setFVinculo({ ...fVinculo, status: e.target.value }) },
                ...
                React.createElement("div", null,
                    React.createElement("label", null, "Ordenar"),
                    React.createElement("select", { value: fVinculo.ordem, onChange: e => setFVinculo({ ...fVinculo, ordem: e.target.value }) },
            ...
            React.createElement(Modal, { titulo: edit.nome ? 'Editar usuário' : 'Novo usuário', onClose: () => setEdit(null) },
                React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 12 } },
                    React.createElement("div", null,
                        ...
                        React.createElement("input", { value: edit.nome, onChange: e => setEdit({ ...edit, nome: e.target.value }) })),
                    React.createElement("div", { className: "form-grid" },
                        React.createElement("div", null,
                            React.createElement("label", null, "UsuarioID"),
                            React.createElement("input", { value: edit.usuarioId || '', readOnly: Boolean(edit.itemId && String(edit.usuarioId || '').trim()), onChange: e => !(edit.itemId && String(edit.usuarioId || '').trim()) && setEdit({ ...edit, usuarioId: e.target.value.toUpperCase() }), title: edit.itemId && String(edit.usuarioId || '').trim() ? 'Identificador permanente: não pode ser alterado após a criação.' : 'Informe o UsuarioID para concluir este cadastro incompleto.' })),
                        React.createElement("div", null,
                            React.createElement("label", null, "Usu\u00E1rio"),
                            React.createElement("input", { value: edit.login, onChange: e => setEdit({ ...edit, login: e.target.value.toLowerCase() }) })),
                        React.createElement("div", null,
                            React.createElement("label", null, "Telefone"),
                            React.createElement("input", { value: edit.telefone || '', onChange: e => setEdit({ ...edit, telefone: e.target.value }) }))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Perfil"),
                        React.createElement("select", { value: edit.perfilAcessoId || '', onChange: e => { const p = cad.perfis.find(x => String(x.itemId) === String(e.target.value)); const permite = p?.permiteModulosApp === true; setEdit({ ...edit, perfilAcessoId: e.target.value, perfil: p?.titulo || edit.perfil, ...(!permite ? { acessoCargas: false, acessoPremiacao: false, acessoChecklist: false, acessoSinistros: false, acessoAgendamentos: false, acessoHistorico: false } : {}) }); } },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Acesso \u00E0 frota"),
                        React.createElement("select", { value: edit.tipoFrotaAcesso, onChange: e => setEdit({ ...edit, tipoFrotaAcesso: e.target.value }) },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Status do usu\u00E1rio"),
                        React.createElement("select", { value: edit.ativo ? 's' : 'n', onChange: e => setEdit({ ...edit, ativo: e.target.value === 's' }) },
        ...
        editPlaca &&
            React.createElement(Modal, { titulo: 'Placa ' + editPlaca.placa, onClose: () => setEditPlaca(null) },
                React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 12 } },
                    React.createElement("div", null,
                        React.createElement("label", null, "Frota"),
                        React.createElement("select", { value: editPlaca.tipoFrota, onChange: e => setEditPlaca({ ...editPlaca, tipoFrota: e.target.value }) },
                            React.createElement("option", null, "FROTA PESADA"),
                            React.createElement("option", null, "FROTA LEVE"))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Placa"),
                        React.createElement("input", { value: editPlaca.placa, disabled: !!editPlaca.itemId, onChange: e => setEditPlaca({ ...editPlaca, placa: e.target.value.toUpperCase() }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Tipo do ve\u00EDculo"),
                        React.createElement("select", { value: editPlaca.tipoModelo, onChange: e => setEditPlaca({ ...editPlaca, tipoModelo: e.target.value }) },
                            React.createElement("option", { value: "" }, "Selecionar..."),
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Uso compartilhado?"),
                        React.createElement("select", { value: editPlaca.usoCompartilhado ? 's' : 'n', onChange: e => setEditPlaca({ ...editPlaca, usoCompartilhado: e.target.value === 's' }) },
                            React.createElement("option", { value: "n" }, "N\u00E3o \u2014 exige v\u00EDnculo"),
                            React.createElement("option", { value: "s" }, "Sim"))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Status do ve\u00EDculo"),
                        React.createElement("select", { value: editPlaca.ativo ? 's' : 'n', onChange: e => setEditPlaca({ ...editPlaca, ativo: e.target.value === 's' }) },
                            React.createElement("option", { value: "s" }, "Ativo"),
                            React.createElement("option", { value: "n" }, "Inativo"))),
        ...
        editVinculo && React.createElement(Modal, { titulo: "V\u00EDnculo usu\u00E1rio \u00D7 ve\u00EDculo", onClose: () => setEditVinculo(null) },
            React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 12 } },
                React.createElement("div", null,
                    React.createElement("label", null, "Usu\u00E1rio"),
                    React.createElement("select", { value: editVinculo.usuarioItemId, onChange: e => setEditVinculo({ ...editVinculo, usuarioItemId: e.target.value }) },
                        React.createElement("option", { value: "" }, "Selecionar..."),
                        cad.usuarios.filter(u => u.ativo).map(u => React.createElement("option", { key: u.itemId, value: u.itemId }, u.nome)))),
                React.createElement("div", null,
                    React.createElement("label", null, "Ve\u00EDculo"),
                    React.createElement("select", { value: editVinculo.veiculoItemId, onChange: e => setEditVinculo({ ...editVinculo, veiculoItemId: e.target.value }) },
                        React.createElement("option", { value: "" }, "Selecionar..."),
                        cad.veiculos.filter(v => v.ativo && !v.usoCompartilhado).map(v => React.createElement("option", { key: v.itemId, value: v.itemId }, v.placa)))),
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", null,
                        React.createElement("label", null, "In\u00EDcio"),
                        React.createElement("input", { type: "date", value: (editVinculo.dataInicio || '').slice(0, 10), onChange: e => setEditVinculo({ ...editVinculo, dataInicio: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Fim"),
                        React.createElement("input", { type: "date", value: (editVinculo.dataFim || '').slice(0, 10), onChange: e => setEditVinculo({ ...editVinculo, dataFim: e.target.value, ativo: !e.target.value }) }))),
                React.createElement("div", null,
                    React.createElement("label", null, "Principal?"),
                    React.createElement("select", { value: editVinculo.principal ? 's' : 'n', onChange: e => setEditVinculo({ ...editVinculo, principal: e.target.value === 's' }) },
                        React.createElement("option", { value: "s" }, "Sim"),
                        React.createElement("option", { value: "n" }, "N\u00E3o"))),
                React.createElement("div", null,
                    React.createElement("label", null, "Observa\u00E7\u00E3o"),
                    React.createElement("textarea", { value: editVinculo.observacao || '', onChange: e => setEditVinculo({ ...editVinculo, observacao: e.target.value }) })),
        ...
        editPerfil && React.createElement(Modal, { large: true, titulo: editPerfil.itemId ? 'Editar perfil' : 'Novo perfil', onClose: () => setEditPerfil(null) },
            React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 12 } },
                React.createElement("div", null,
                    ...
                    React.createElement("input", { value: editPerfil.titulo || '', onChange: e => setEditPerfil({ ...editPerfil, titulo: e.target.value.toUpperCase() }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Descri\u00E7\u00E3o"),
                    React.createElement("textarea", { value: editPerfil.descricao || '', onChange: e => setEditPerfil({ ...editPerfil, descricao: e.target.value }) })),
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", null,
                        React.createElement("label", null, "N\u00EDvel de acesso"),
                        React.createElement("select", { value: editPerfil.nivelAcesso || 'SOMENTE_VISUALIZAR', onChange: e => setEditPerfil({ ...editPerfil, nivelAcesso: e.target.value }) },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Permite m\u00F3dulos do app?"),
                        React.createElement("select", { value: editPerfil.permiteModulosApp ? 's' : 'n', onChange: e => setEditPerfil({ ...editPerfil, permiteModulosApp: e.target.value === 's' }) },
                            React.createElement("option", { value: "s" }, "Sim"),
                            React.createElement("option", { value: "n" }, "N\u00E3o"))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Status"),
                        React.createElement("select", { value: editPerfil.ativo ? 's' : 'n', onChange: e => setEditPerfil({ ...editPerfil, ativo: e.target.value === 's' }) },
                            React.createElement("option", { value: "s" }, "Ativo"),
                            React.createElement("option", { value: "n" }, "Inativo")))),
                React.createElement("div", null,
        ...
        editTipo && React.createElement(Modal, { titulo: editTipo.itemId ? 'Editar tipo de veículo' : 'Novo tipo de veículo', onClose: () => setEditTipo(null) },
            React.createElement("div", { className: "form-grid" },
                React.createElement("div", { style: { gridColumn: '1/-1' } },
                    React.createElement("label", null, "Nome do tipo de ve\u00EDculo"),
                    React.createElement("input", { value: editTipo.nome, onChange: e => setEditTipo({ ...editTipo, nome: e.target.value.toUpperCase() }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Frota"),
                    React.createElement("select", { value: editTipo.tipoFrota, onChange: e => setEditTipo({ ...editTipo, tipoFrota: e.target.value }) },
                        React.createElement("option", null, "FROTA PESADA"),
                        React.createElement("option", null, "FROTA LEVE"))),
                React.createElement("div", null,
                    React.createElement("label", null, "Status"),
                    React.createElement("select", { value: editTipo.ativo ? 's' : 'n', onChange: e => setEditTipo({ ...editTipo, ativo: e.target.value === 's' }) },
                        React.createElement("option", { value: "s" }, "Ativo"),
                        React.createElement("option", { value: "n" }, "Inativo"))),
                React.createElement("div", null,
                    React.createElement("label", null, "PBT (kg)"),
                    React.createElement("input", { type: "number", min: "0", value: editTipo.pbtKg, onChange: e => setEditTipo({ ...editTipo, pbtKg: Number(e.target.value) }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Capacidade de carga (kg)"),
                    React.createElement("input", { type: "number", min: "0", value: editTipo.capacidadeCargaKg, onChange: e => setEditTipo({ ...editTipo, capacidadeCargaKg: Number(e.target.value) }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Toler\u00E2ncia superior (kg)"),
                    React.createElement("input", { type: "number", min: "0", value: editTipo.toleranciaSuperiorKg, onChange: e => setEditTipo({ ...editTipo, toleranciaSuperiorKg: Number(e.target.value) }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Toler\u00E2ncia inferior (kg)"),
                    React.createElement("input", { type: "number", min: "0", value: editTipo.limiteInferiorKg, onChange: e => setEditTipo({ ...editTipo, limiteInferiorKg: Number(e.target.value) }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Validar faixa de carga?"),
                    React.createElement("select", { value: editTipo.exigeAprovacaoAbaixo ? 's' : 'n', onChange: e => setEditTipo({ ...editTipo, exigeAprovacaoAbaixo: e.target.value === 's' }) },
                        React.createElement("option", { value: "n" }, "N\u00E3o"),
                        React.createElement("option", { value: "s" }, "Sim"))),
                React.createElement("div", { style: { gridColumn: '1/-1' } },
                    React.createElement("label", null, "Observa\u00E7\u00E3o"),
                    React.createElement("textarea", { value: editTipo.observacao || '', onChange: e => setEditTipo({ ...editTipo, observacao: e.target.value }) }))),
    ...
    return React.createElement(React.Fragment, null,
        ...
        sub === 'gestao' && podeGestao && React.createElement(React.Fragment, null,
            React.createElement("div", { className: "card" },
                React.createElement("div", { className: "filtros-cadastro", style: { margin: 0 } },
                    React.createElement("div", null,
                        React.createElement("label", null, "Pesquisar"),
                        React.createElement("input", { value: filtro.texto, onChange: e => setFiltro({ ...filtro, texto: e.target.value }), placeholder: "Protocolo, placa, motorista..." })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Status"),
                        React.createElement("select", { value: filtro.status, onChange: e => setFiltro({ ...filtro, status: e.target.value }) },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Compet\u00EAncia"),
                        React.createElement("input", { type: "month", value: filtro.competencia || '', onChange: e => setFiltro({ ...filtro, competencia: e.target.value }) })),
                    React.createElement("div", null,
                        React.createElement("label", null, "Tipo de ocorr\u00EAncia"),
                        React.createElement("select", { value: filtro.tipoOcorrencia || '', onChange: e => setFiltro({ ...filtro, tipoOcorrencia: e.target.value }) },
                            React.createElement("option", { value: "" }, "Todos"),
                            ['Acidente', 'Pane', 'Avaria', 'Furto / Roubo / Vandalismo', 'Outro'].map(x => React.createElement("option", { key: x }, x)))),
                    React.createElement("div", null,
                        React.createElement("label", null, "Gravidade"),
                        React.createElement("select", { value: filtro.gravidade, onChange: e => setFiltro({ ...filtro, gravidade: e.target.value }) },
                            React.createElement("option", { value: "" }, "Todas"),
        ...
        sub === 'config' && podeConfig && React.createElement(React.Fragment, null, !config ? React.createElement("div", { className: "card" },
            ...
            React.createElement("div", { className: "form-grid" },
                React.createElement("div", null,
                    ...
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.titulo || '', onChange: e => setConfig({ ...config, titulo: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Status"),
                    React.createElement("select", { disabled: !podeEditarConfig, value: config.ativo ? 's' : 'n', onChange: e => setConfig({ ...config, ativo: e.target.value === 's' }) },
                        React.createElement("option", { value: "s" }, "Ativo"),
                        React.createElement("option", { value: "n" }, "Inativo"))),
                React.createElement("div", null,
                    React.createElement("label", null, "E-mail principal"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.emailPrincipal || '', onChange: e => setConfig({ ...config, emailPrincipal: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "E-mails em c\u00F3pia"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.emailCopia || '', onChange: e => setConfig({ ...config, emailCopia: e.target.value }), placeholder: "Separar por ;" })),
                React.createElement("div", null,
                    React.createElement("label", null, "C\u00F3pia oculta"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.emailCopiaOculta || '', onChange: e => setConfig({ ...config, emailCopiaOculta: e.target.value }), placeholder: "Separar por ;" })),
                React.createElement("div", null,
                    React.createElement("label", null, "Assunto do e-mail"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.assuntoEmail || '', onChange: e => setConfig({ ...config, assuntoEmail: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Contato de emerg\u00EAncia"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.nomeContatoEmergencia || '', onChange: e => setConfig({ ...config, nomeContatoEmergencia: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Telefone de emerg\u00EAncia"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.telefoneEmergencia || '', onChange: e => setConfig({ ...config, telefoneEmergencia: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Revis\u00E3o do procedimento"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.revisaoProcedimento || '', onChange: e => setConfig({ ...config, revisaoProcedimento: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Vers\u00E3o do m\u00F3dulo"),
                    React.createElement("input", { disabled: !podeEditarConfig, value: config.versaoModulo || '', onChange: e => setConfig({ ...config, versaoModulo: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "Enviar e-mail autom\u00E1tico?"),
                    React.createElement("select", { disabled: !podeEditarConfig, value: config.enviarEmailAutomatico ? 's' : 'n', onChange: e => setConfig({ ...config, enviarEmailAutomatico: e.target.value === 's' }) },
                        React.createElement("option", { value: "s" }, "Sim"),
                        React.createElement("option", { value: "n" }, "N\u00E3o"))),
                React.createElement("div", null,
                    React.createElement("label", null, "Permitir reabertura?"),
                    React.createElement("select", { disabled: !podeEditarConfig, value: config.permiteReabrirSinistro ? 's' : 'n', onChange: e => setConfig({ ...config, permiteReabrirSinistro: e.target.value === 's' }) },
                        React.createElement("option", { value: "s" }, "Sim"),
                        React.createElement("option", { value: "n" }, "N\u00E3o"))),
                React.createElement("div", null,
                    React.createElement("label", null, "Dias para reabertura"),
                    React.createElement("input", { type: "number", min: "0", disabled: !podeEditarConfig, value: config.diasReabertura || 0, onChange: e => setConfig({ ...config, diasReabertura: Number(e.target.value) || 0 }) })),
                React.createElement("div", { style: { gridColumn: '1/-1' } },
                    React.createElement("label", null, "Procedimento"),
                    React.createElement("textarea", { rows: "5", disabled: !podeEditarConfig, value: config.procedimento || '', onChange: e => setConfig({ ...config, procedimento: e.target.value }) })),
                React.createElement("div", null,
                    React.createElement("label", null, "\u00DAltima atualiza\u00E7\u00E3o"),
                    React.createElement("input", { disabled: true, value: config.ultimaAtualizacao ? new Date(config.ultimaAtualizacao).toLocaleString('pt-BR') : '' }))),
        ...
        selecionado && React.createElement(Modal, { large: true, titulo: selecionado.numeroSinistro + ' — ' + selecionado.placa, onClose: () => setSelecionado(null) },
            ...
            React.createElement("div", { className: "card", style: { marginTop: 10 } },
                React.createElement("div", { className: "form-grid" },
                    React.createElement("div", null,
                        React.createElement("label", null, "Status"),
                        React.createElement("select", { disabled: !pode(user, 'sinistros.gerenciar'), value: edicao.statusSinistro, onChange: e => { setEdicao({ ...edicao, statusSinistro: e.target.value }); if (normalizarPerfil(e.target.value) !== 'AGUARDANDO_DOCUMENTOS')
                    ...
                    React.createElement("div", null,
                        React.createElement("label", null, "Gravidade"),
                        React.createElement("select", { disabled: !pode(user, 'sinistros.gerenciar'), value: edicao.gravidade, onChange: e => setEdicao({ ...edicao, gravidade: e.target.value }) }, ['Baixa', 'Media', 'Alta', 'Critica'].map(x => React.createElement("option", { key: x }, x)))),
                    React.createElement("div", { style: { gridColumn: '1/-1' } },
                        React.createElement("label", null, "Observa\u00E7\u00E3o administrativa"),
                        React.createElement("textarea", { disabled: !pode(user, 'sinistros.gerenciar'), rows: "3", value: edicao.observacao, onChange: e => setEdicao({ ...edicao, observacao: e.target.value }), placeholder: "Registre a orienta\u00E7\u00E3o ou andamento relevante." }))),
